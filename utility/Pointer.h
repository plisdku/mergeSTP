 ...
 *
 *  $Rev:: 126                           $:  Revision of last commit
 *  $Author:: pch                        $:  Author of last commit
 *
 *  $Date: 2009-08-18 15:49:38 -0700 (Tue, 18 Aug 2009) $:
 *  $Id: Pointer.h 126 2009-08-18 22:49:38Z pch $:
 *
 */
...
public:
	...
	*/
    ...
    int refcount() const;
	static const std::map<T*,int> & map() { return mReferenceCounts; }
...
protected:
    ...
    static std::map<T*, int> mReferenceCounts;
    
    void decrementPointer();
};

template<typename T>
std::map<T*, int> Pointer<T>::mReferenceCounts;
